...
class ConversationSession:
    ...
    # 4-step pipeline intermediate state
    last_intent_state: Optional[dict] = None       # Step 1 result
    last_diff_result: Optional[dict] = None         # Step 3 result
    ...
    def build_optimized_messages(
        ...
        if defined_params or floating_params:
            ...
            augmented += (
                ...
                "Compare the user-specified parameters against the provided documentation. "
                "Help the user determine if they are missing any required parameters for their task.\n\n"
            )
        else:
            # No slash commands
            pass
